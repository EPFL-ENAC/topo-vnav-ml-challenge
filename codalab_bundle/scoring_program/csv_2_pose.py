...
def sixd_csv_array_to_txt_pose():
 """
 Read the 6D position from the CSV file and transform them into numpy array. Save the numpy arry into a text file
 :return: None
 """
 ...
 for i,pose in enumerate(poses):
  ...
  file_path = os.path.join(settings.path_folder_poses_txt.replace('poses','poses_verification'),file_name)
